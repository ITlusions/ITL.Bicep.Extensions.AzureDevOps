...
1. **[Quick Start Guide](QUICKSTART.md)** — Get running in 5 minutes with CI/CD service containers
...
- **[Deployment Guide](DEPLOYMENT.md)** — All deployment options (service containers, ACI, AKS, App Service, local)
...
1. Read [Quick Start](QUICKSTART.md) (~5 min)
...
2. [Deployment Guide](DEPLOYMENT.md) — Choose your deployment pattern
...
1. [Deployment Guide](DEPLOYMENT.md) — Production deployment patterns
2. [Troubleshooting](TROUBLESHOOTING.md) — Debug authentication, API errors, performance
...
| I want to... | Go to... |
|---|---|
| Deploy service connections in my pipeline | [Quick Start](QUICKSTART.md) |
...
| Fix 401/403 authentication errors | [Troubleshooting § Authentication](TROUBLESHOOTING.md#authentication-issues) |
| Deploy to AKS with workload identity | [Deployment § AKS](DEPLOYMENT.md#3-azure-kubernetes-service-aks) |
